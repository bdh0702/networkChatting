...
public class Exam9_3_S extends Frame {
   ...
   public ServerThread(Exam9_3_S c, Socket s, TextArea ta) {
         sock = s;
         display = ta;
         cs = c;
         try {
