...
public class FileThread extends Thread {
	...
	private void readFile(BufferedInputStream bin,byte[] data,int fileLength) throws IOException{
		int size = 2048;
		...
		for(int i=0; i<=count; i++) {
			if(i==count && flag ==0) {
				...
				recv.lbl.setText("파일 수신중...(" + ((i+1)*size) + "/"+ fileLength + " Byte)");
