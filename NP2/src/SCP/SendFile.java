...
public class SendFile extends Frame implements ActionListener{
	...
	public SendFile(String address,String port) {
		super("파일 전송");
	...
	private void sendFile(BufferedOutputStream bout,byte[] data,int fileLength) throws IOException{
		int size = 2048;
